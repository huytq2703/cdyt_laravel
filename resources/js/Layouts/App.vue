...
<template>
    <div class="container mx-auto">
        <div
            class="border-bottom-1 w-full py-2 flex justify-content-between xl:px-0 px-3"
        >
            <a
                href="#"
            ...
            <div class="flex gap-3">
                ...
                >
                    ...
                    ><span class="sm:inline hidden">Sitemap</span>
                </a>
                <Link
                ...
                >
                    ...
                    ><span class="sm:inline hidden">Quản lý đào tạo</span>
                </Link>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto">
        <div
            class="flex border-bottom-1 py-2 bg-title bg-title-right font-bold"
        >
        ...
        <div class="container py-5">
            <div class="flex justify-content-between flex-wrap gap-3">
                <div class="flex flex-column text-white font-bold">
                    ...
                    />
                    <p>
                        Địa chỉ: 32 Y Ngông - P. Tân Tiến - Tp.Buôn Ma Thuột -
                        Tỉnh Đắk Lắk
                    </p>
                ...
                <div class="">
                    <h3 class="font-bold text-white text-xl border-bottom-2">
                        Thống kê truy cập
                    </h3>
