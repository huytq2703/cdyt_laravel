...
<template>
    ...
    <div class="md:flex container mx-auto hidden overflow-scroll hide-scroll">
        <div v-for="item in menu" class="" :key="item.label">
            <div v-if="item?.child" class="dropdown2">
                <button
                    class="dropbtn flex align-items-center gap-2 nav-link white-space-nowrap"
                >
    ...
    <Sidebar
        v-model:visible="menuFullVisible"
        :baseZIndex="1000"
        position="full"
    >
        <div v-for="item in menu" class="" :key="item.label">
            <div v-if="item?.child" class="mobile-dropdown">
                <button
                    class="mobile-dropbtn flex align-items-center gap-2 font-bold"
                >
                    {{ item.label }}<i class="pi pi-caret-down"></i>
                </button>
            ...
            <a
                href=""
                class="flex flex-nowrap white-space-nowrap font-bold mb-1"
                >{{ item.label }}</a
            >
        </div>
    </Sidebar>
