...
<template>
  ...
  <App>
    <div class="container mx-auto">
      ...
      <div class="col-12">
        ...
        <div class="row">
          <div class="col-lg-4 col-sm-4">
            <div class="m-2 card h-16rem text-white bg-danger">
          ...
          <div class="col-lg-4 col-sm-4">
            <div class="m-2 card h-16rem text-white bg-warning">
              <div class="card-body hover-text">
                <h1 class="card-title text-center">
          ...
          <div class="col-lg-4 col-sm-4">
            <div class="m-2 card h-16rem text-white bg-info">
              <div class="card-body hover-text">
                <h1 class="card-title text-center">
      ...
      <br />
      <div class="col-12 text-white pr-4" style="background-color: rgb(114, 14, 16)">
        <div class="row p-3 mt-5 mb-2">
          <div class="d-flex flex-column justify-content-center col-md-6">
            ...
            <br />
            <h4>
              Nhập thông tin để tư vấn viên của trường liên hệ giải đáp các thắc mắc hoàn
              toàn miễn phí. Chúng tôi sẽ chủ động liên hệ lại với bạn trong vòng 24h kể
              từ khi nhận được thông tin đăng ký.
            </h4>
          </div>
          <div class="border p-4 rounded-3 col-md-6">
            <RegistrationForm />
          </div>
        </div>
      </div>
