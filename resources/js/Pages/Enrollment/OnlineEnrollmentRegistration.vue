  ...
  <App>
    <div class="container py-3">
      ...
      >
        ...
        <p class="mt-4">“Hãy đăng ký liên hệ nhà trường để được hỗ trợ, hướng dẫn.</p>
      </div>
          ...
          <div class="border flex flex-column p-5">
            ...
            <div class="flex flex-column md:flex-row w-full gap-0 md:gap-5">
              ...
              <div class="field flex flex-column md:w-10rem w-full">
                <label for="gender" class="font-bold">Giới tính</label>
                <Dropdown
                  id="gender"
                ...
                />
                <small v-if="errors.phoneNumber" id="gender-help" class="p-error">{{
                  errors.phoneNumber
                }}</small>
              </div>
            </div>
            ...
            >
              <div class="field flex-1 flex flex-column">
                ...
                />
                <small v-if="errors.email" id="religion-help" class="p-error">{{
                  errors.email
                }}</small>
              </div>

              <div class="field flex-1 flex flex-column">
                <label for="nation" class="font-bold">Dân tộc</label>
                <InputText
                  v-model="contactForm.email"
                  id="nation"
                  ...
                  placeholder="Dân tộc *"
                />
                <small v-if="errors.email" id="nation-help" class="p-error">{{
                  errors.email
                }}</small>
              </div>

              <div class="field flex-1 flex flex-column">
                <label for="level" class="font-bold">Trình độ</label>
                ...
                <small v-if="errors.email" id="level-help" class="p-error">{{
                  errors.email
                }}</small>
              </div>
              ...
              <div class="field flex-1 flex flex-column">
                ...
                />
                <small v-if="errors.email" id="priority-help" class="p-error">{{
                  errors.email
                }}</small>
              </div>
            </div>
            ...
            <!-- Row -->
            <div class="field flex-1 flex flex-column">
              <label for="Majors" class="font-bold">Ngành học</label>
              ...
              <Dropdown
                ...
                filterPlaceholder=""
              />
              <small v-if="errors.Majors" id="Majors-help" class="p-error">{{
                errors.Majors
              }}</small>
            </div>
            ...
            <!-- Row -->
            <div class="field flex-1 flex flex-column">
              <label for="address" class="font-bold">Địa chỉ liên hệ</label>
              <InputText
                v-model="contactForm.phoneNumber"
                id="address"
              ...
              />
              <small v-if="errors.address" id="address-help" class="p-error">{{
                errors.address
              }}</small>
            </div>
            ...
            <div class="flex justify-content-between md:gap-3 md:flex-row flex-column">
              <div class="field flex-1 flex flex-column">
                <Dropdown
                  ...
                  filterPlaceholder=""
                />
                <small v-if="errors.province" id="province-help" class="p-error">{{
                  errors.province
                }}</small>
              </div>
              <div class="field flex-1 flex flex-column">
                <Dropdown
                  ...
                  filterPlaceholder=""
                />
                <small v-if="errors.district" id="district-help" class="p-error">{{
                  errors.district
                }}</small>
              </div>
              ...
              <div class="field flex-1 flex flex-column">
                <Dropdown
                  ...
                  filterPlaceholder=""
                />
                <small v-if="errors.ward" id="ward-help" class="p-error">{{
                  errors.ward
                }}</small>
              </div>
            </div>
